...
#pragma warning disable 1591
	...
	public struct Base2
	{
		...
		public decimal Bytes { get { return Convert.ToDecimal(Bits / 8); } set { Bits = Convert.ToUInt64(Decimal.Round(value * 8, 0)); storeMode = Base2StorageMode.Bytes; } }
		public long BytesNormalized { get { return Convert.ToInt64(Decimal.Round(Bits / 8, 0)); } }
		...
		public static Base2 Parse(string Value, Base2ParseMode ParseMode, bool Round)
		{
			...
			if (ParseMode == Base2ParseMode.Binary)
			{
				...
				{
					if (Round)
						ret.Kibibits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Kibibytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Mebibits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Mebibytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Gibibits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Gibibytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Tebibits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Tebibytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Pebibits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Pebibytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
			...
			if (ParseMode == Base2ParseMode.Scientific)
			{
				...
				{
					if (Round)
						ret.Kilobits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Kilobytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Megabits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Megabytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Gigabits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Gigabytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Terabits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Terabytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Petabits = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
				...
				{
					if (Round)
						ret.Petabytes = Decimal.Round(Convert.ToDecimal(r.Replace(Value, "")), 0);
					else
