...
{
	/// <summary>
	/// Provides hash computation services using the SHA-2 family of algorithms. It supports the 256-bit hashes.
	...
	public static class Hash
	{
		...
		{
			return BitConverter.ToString(SHA256.ComputeHash(System.Text.Encoding.UTF8.GetBytes(Data))).Replace("-", "");
		}
