...
{
	/// <summary>
	/// Provides encryption and decryption capabilites using 128-bit AES encryption methods.
	...
	public static class Encryption
	{
		...
		private static KeyData GenerateKeyIV128(byte[] Key)
		{
			...
			byte[] IVH = Hash.Compute256Byte(Key);
		...
		public static string Encrypt128Base64(string Data, byte[] Key)
		{
			...
			try
			{
				...
				AES = new AesManaged { BlockSize = 128, KeySize = 128, Key = KeyData.Key, IV = KeyData.IV };
