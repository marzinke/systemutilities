...
{
	/// <summary>
	/// Provides encryption and decryption capabilites using 128-bit, 192-bit, and 256-bit Rijndael encryption methods.
	...
	public static class Encryption
	{
		...
		public static string Encrypt192Base64(string Data, byte[] Key)
		{
			...
			try
			{
				...
				KeyData KeyData = GenerateKeyIV128(Key);
				//Create the AES crytpograhy object.
				AES = new RijndaelManaged { BlockSize = 192, KeySize = 192, Key = KeyData.Key, IV = KeyData.IV, Mode = CipherMode.CBC, Padding = PaddingMode.PKCS7 };
				CS = new CryptoStream(MS, AES.CreateEncryptor(), CryptoStreamMode.Write);
