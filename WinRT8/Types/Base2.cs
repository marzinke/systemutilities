...
#pragma warning disable 1591
	...
	public struct Base2
	{
		...
		public decimal Bytes { get { return Convert.ToDecimal(Bits / 8); } set { Bits = Convert.ToUInt64(Math.Round(value*8, 0)); storeMode = Base2StorageMode.Bytes; } }
		public long BytesNormalized { get { return Convert.ToInt64(Math.Round((decimal)Bits / 8, 0)); } }
